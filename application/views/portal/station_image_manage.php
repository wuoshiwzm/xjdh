                        ...
                        <?php if ($stationimGnewGrouping) { ?>
                            ...
                            <div class="tab-widget tabbable tabs-left chat-widget">
                                <div class="tab-content" style='height: 800px;'>
                                    <?php $i = $offset + 1;
                                    foreach ($stationimGnewGrouping as $substationObj) { ?>
                                        <br><h3><?php echo $substationObj->newGrouping ?></h3><br>
                                        <ul class="dowebok">
                                            <?php $i = $offset + 1;
                                            foreach ($substationGatherimg as $substationObjs) { ?>
                                                <?php if ($substationObjs->newGrouping == $substationObj->newGrouping) { ?>
                                                    <li class="dowebok1">
                                                        <a rel="group"
                                                           href="/public/portal/Station_image/<?php echo $substationObjs->stationImage ?>">
                                                            <img class="example1"
                                                                 src="/portal/station_thumb/<?php echo $substationObjs->stationImage ?>"/></a>

                                                        <a class="deleteImg" val="<?php echo $substationObjs->id ?>"
                                                           href="#">删除</a>/<a
                                                                href="/portal/updat_Stationimage/<?php echo $substationObjs->id ?>">修改</a>/
                                                        <?php if (substr(strrchr($substationObjs->stationImage, '.'), 0) == ".flv") { ?>
                                                            <a rel="group" class="video"
                                                               href="#<?php echo $substationObjs->stationImage ?>">video
                                                                link</a>
                                                        <?php } else { ?>
                                                            <a rel="group" class="image"
                                                               href="/public/portal/Station_image/<?php echo $substationObjs->stationImage ?>">文本
                                                            </a>
                                                        <?php } ?>
                                ...
                                <table
                                    ...
                                    foreach ($substationList as $substationObj) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($substationObj['lat'], ENT_COMPAT, "UTF-8"); ?>
                                                /<?php echo htmlentities($substationObj['lng'], ENT_COMPAT, "UTF-8"); ?></td>
                                                    ...
                                                    <?php foreach ($substationObj['img'] as $imgObj) { ?>
                                                        <li class="dowebok1">
                                                            <?php if (substr(strrchr($imgObj, '.'), 0) == ".flv") { ?>
                                                                <a rel="group" class="video"
                                                                   href="#<?php echo $imgObj ?>">Vedio Link</a>
                                                            <?php } else { ?>
                                                                <a rel="group" class="image"
                                                                   href="/public/portal/Station_image/<?php echo $imgObj ?>">
                                            ...
                                            <td><a class="btn btn-info"
                                                   href="/portal/station_image_manage?substationid=<?php echo $substationObj['id']; ?>">详细信息</a>
                                                <a class="btn btn-info" id="editstations"
                                                   href="/portal/editsubstation?substationid=<?php echo $substationObj['id']; ?>">确认采集局站</a>
                                                <a hrefvalue="<?php echo $substationObj['id'] ?>" id="deletestation"
                                                   class="btn btn-info hrefvalue">删除局站</a>
                                                <a class="btn btn-info" id="editstation"
                                                   href="/portal/editsubstationGather/<?php echo $substationObj['id']; ?>">添加图片</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>

			...
			<div class='span12'>
				<div class="tab-widget">
					<ul class="nav nav-tabs">
                	   <li><a href="/portal/door_user_list/<?php echo htmlentities($userObj->id,ENT_COMPAT,"UTF-8"); ?>"><i class="icon-tasks"></i>用户权限管理</a></li>
                	   <li><a href="/portal/door_user_operate/<?php echo htmlentities($userObj->id,ENT_COMPAT,"UTF-8"); ?>"><i class="icon-tasks"></i>授权记录</a></li>
                	   <li class="active"><a href="/portal/door_user_record/<?php echo htmlentities($userObj->id,ENT_COMPAT,"UTF-8"); ?>"><i class="icon-tasks"></i>开门记录</a></li>
					</ul>
				</div>
			</div>
		</div>

				...
				<div class="content-widgets light-gray">
					...
					<div class="widget-container">
						...
						<table
							...
							<tbody>
							<?php $i = 1;foreach ($netSubList as $netSubObj){?>
							 <tr>
									<td><?php echo $i++;?></td>
									<td><?php echo htmlentities($netSubObj->nk_script,ENT_COMPAT,"UTF-8");?></td>
									<td><?php echo htmlentities($netSubObj->nk_value,ENT_COMPAT,"UTF-8");?></td>
									<td nk_id='<?php echo htmlentities($netSubObj->nk_id,ENT_COMPAT,"UTF-8");?>'
								...
								<table
									...
									<tbody>
							         <?php $i = 0; foreach ($devList as $devObj){?>
							             <tr>
											<td><?php echo ++$i;?></td>
											<td><?php echo htmlentities($devObj->property,ENT_COMPAT,"UTF-8");?></td>
											<td><?php echo htmlentities($devObj->name,ENT_COMPAT,"UTF-8");?></td>
											<td><?php echo htmlentities($devObj->requirements,ENT_COMPAT,"UTF-8");?></td>
											<td><?php echo htmlentities($devObj->value,ENT_COMPAT,"UTF-8");?></td>
											<td><input type="radio" class='rChoose' name='radio_device'
												nk_id='<?php echo htmlentities($devObj->id,ENT_COMPAT,"UTF-8")?>'
												substation_id='<?php echo $substation_id;?>'
												value='<?php echo htmlentities($devObj->value,ENT_COMPAT,"UTF-8");?>'
												networkname='<?php echo htmlentities($devObj->name,ENT_COMPAT,"UTF-8");?>'></td>
										</tr>
						             <?php }?>
							         </tbody>
								</table>

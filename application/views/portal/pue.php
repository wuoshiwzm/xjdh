					...
					<div class="widget-container">
						<table
							...
							<tr id="<?php echo $stationObj->id; ?>">
									<td><?php echo $i++;?></td>
									<td><?php echo htmlentities(Defines::$gCity[$stationObj->city_code],ENT_COMPAT,"UTF-8");?></td>
									<td><?php echo htmlentities(Defines::$gCounty[$stationObj->city_code][$stationObj->county_code],ENT_COMPAT,"UTF-8");?></td>
									<td><?php echo htmlentities($stationObj->name, ENT_COMPAT, "UTF-8"); ?></td>
									<td></td>
									<td></td>
									<td></td>
									<td></td>
